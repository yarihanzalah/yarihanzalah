...
<br><br><br>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			<li class="active"><a href="home-kasir.php"><span class="glyphicon glyphicon-home"></span> HOME</a></li>
            <li><a href="makanan.php"><span class="glyphicon glyphicon-cutlery"></span> MAKANAN</a></li>
            <li><a href="food-stock.php"><span class="glyphicon glyphicon-cutlery"></span>  STOCK MAKANAN</a></li>
            <li><a href="minuman.php"><span class="glyphicon glyphicon-glass"></span>  MINUMAN</a></li>
            <li><a href="drink-stok.php"><span class="glyphicon glyphicon-glass"></span> STOCK MINUMAN</a></li>
             <li><a href="meja.php"><span class="glyphicon glyphicon-blackboard"></span> MEJA</a></li>
            <li><a href="user.php"><span class="glyphicon glyphicon-user"></span>  USER</a></li>
             <li><a href="level.php"><span class="glyphicon glyphicon-tag"></span>  LEVEL</a></li>
            <li><a href="detail-order.php"><span class="glyphicon glyphicon-list-alt"></span>  DETAIL ORDER</a></li>
            <li><a href="transaksi.php"><span class="glyphicon glyphicon-list"></span> TRANSAKSI</a></li>
            <li><a href="order.php"><span class="glyphicon glyphicon-briefcase"></span>  ORDER</a></li>
             <li><a href="penjualan.php"><span class="glyphicon glyphicon-bell"></span> PENJUALAN</a></li>
